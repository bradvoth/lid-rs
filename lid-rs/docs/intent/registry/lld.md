...
| Type | Fields | Purpose |
|---|---|---|
| `SpecMeta` | `name: &'static str`, `file: &'static str`, `line: u32` | One registered claim. `name` is `<Struct as lid_rs::Spec>::NAME`, making the key identical on both sides of every join. |
