...
number, with the total; and a workspace line at the top of the document
summing them. It is a line of text in a diff, which is the entire point — §3.7
...
emitted tests apply the same functions to the real registries.
