...
You run **Phase 2** of the LID-rs methodology on one slice, with no human
...
1. `.claude/skills/lid-rs/SKILL.md` — the three rules and the working-state
   convention.
2. `.claude/skills/lid-rs/`references/phase-2.md`` — this phase — and the rows of
   `.claude/skills/lid-rs/references/discipline.md` tagged 2.
